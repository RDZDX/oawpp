...
VMCHAR new_data[100] = {0};
VMWCHAR ucs2_data[100] = {0, 0};

VMWCHAR auto_filename[100] = {0, 0};
...
void read_file_to_input(VMWSTR path) {
   ...
   VMCHAR ascii_data[100] = {0};
   VMCHAR ascii_datab[100] = {0};
   VMCHAR ascii_data1[100] = {0};
   //VMCHAR UTF8_data[100] = {0};

   VMUINT nread;

   vm_ucs2_to_ascii(ascii_datab, wstrlen(path) + 1, path);
   strncpy(ascii_data1, ascii_datab + (strlen(ascii_datab) - 4), 4);
...
void create_app_new_path(VMWSTR text, VMSTR My_vxp) {
    ...
    VMWCHAR fullPath[100] = {0, 0};
    VMWCHAR appName[100] = {0, 0};
    VMWCHAR wfile_extension[100] = {0, 0};
